...
<head>
    ...
    <title>Dashboard Siswa - SI BKK</title>
            ...
            <div class="sidebar-content js-simplebar">
                ...
                @if (auth()->user()->role->role == 'admin')
                    ...
                    <li class="sidebar-item">
                        ...
                        onclick="event.preventDefault(); Swal.fire({ title: 'Konfirmasi Keluar', text: 'Apakah Anda yakin ingin keluar?', icon: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor: '#d33', confirmButtonText: 'Ya, Keluar!' }).then((result) => { if (result.isConfirmed) { document.getElementById('logout-form').submit(); } });">
                ...
                @elseif (auth()->user()->role->role == 'siswa')
                    ...
                    <li class="sidebar-header">Menu Utama</li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/minat-siswa">
                            <i class="bi bi-star"></i> <span class="align-middle">Minat Siswa</span>
                        </a>
                    </li>
